    ...
    public function asArray(): array
    {
        return array_filter(
            [
                ...
                'fp' => is_numeric($this->event->userFingerprint) ? (string) $this->event->userFingerprint : null,
                'cookie' => (string) (int) $this->event->permitsCookies,
                'lang' => $this->event->browserLanguage,
                'f_pdf' => (string) (int) $this->event->adobePdfPluginInstalled,
                'f_qt' => (string) (int) $this->event->quicktimePluginInstalled,
                'f_realp' => (string) (int) $this->event->realplayerInstalled,
                'f_wma' => (string) (int) $this->event->windowsMediaPluginInstalled,
                'f_dir' => (string) (int) $this->event->directorPluginInstalled,
                'f_fla' => (string) (int) $this->event->flashPluginInstalled,
                'f_gears' => (string) (int) $this->event->googleGearsPluginInstalled,
                'f_ag' => (string) (int) $this->event->silverlightPluginInstalled,
                'cd' => is_numeric($this->event->browserColorDept) ? (string) $this->event->browserColorDept : null,
